...
export default function DashProfile() {
  ...
  return (
    <div className="max-w-lg mx-auto m p-3 w-full">
      ...
      <div className=" cursor-pointer text-red-500 flex justify-between mt-5">
        <span
          onClick={() => setShowModal(true)}
          className="curson-pointer hover:underline"
        >
          Delete Account
        </span>
        <span
